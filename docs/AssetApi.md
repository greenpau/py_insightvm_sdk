...
api_instance = py_insightvm_sdk.AssetApi()
...
asset = py_insightvm_sdk.AssetCreate() # AssetCreate | The details of the asset being added or updated.  The operating system can be specified in one of three ways, with the order of precedence: `\"osFingerprint\"`, `\"os\"`, `\"cpe\"` (optional)
...
# create an instance of the API class
api_instance = py_insightvm_sdk.AssetApi()
param1 = py_insightvm_sdk.SearchCriteria() # SearchCriteria | param1
