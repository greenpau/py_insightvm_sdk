# py_insightvm_sdk.AssetDiscoveryApi
...
api_instance = py_insightvm_sdk.AssetDiscoveryApi()
query = py_insightvm_sdk.SonarQuery() # SonarQuery | The criteria for a Sonar query. (optional)
...
# create an instance of the API class
api_instance = py_insightvm_sdk.AssetDiscoveryApi()
query = py_insightvm_sdk.SonarCriteria() # SonarCriteria | The criteria for a Sonar query. (optional)
