...
api_instance = py_insightvm_sdk.UserApi()
...
# create an instance of the API class
api_instance = py_insightvm_sdk.UserApi()
user = py_insightvm_sdk.UserEdit() # UserEdit | The details of the user. (optional)
...
api_instance = py_insightvm_sdk.UserApi()
id = 56 # int | The identifier of the user.
asset_group_ids = [py_insightvm_sdk.list[int]()] # list[int] | The identifiers of the asset groups to grant the user access to. Ignored if user has access to `allAssetGroups`. (optional)
...
api_instance = py_insightvm_sdk.UserApi()
id = 56 # int | The identifier of the user.
site_ids = [py_insightvm_sdk.list[int]()] # list[int] | The identifiers of the sites to grant the user access to. Ignored if the user has access to `allSites`. (optional)
...
api_instance = py_insightvm_sdk.UserApi()
id = 'id_example' # str | The identifier of the role.
role = py_insightvm_sdk.Role() # Role | The details of the role. (optional)
