# py_insightvm_sdk.ScanEngineApi
...
api_instance = py_insightvm_sdk.ScanEngineApi()
...
# create an instance of the API class
api_instance = py_insightvm_sdk.ScanEngineApi()
scan_engine = py_insightvm_sdk.ScanEngine() # ScanEngine | The specification of a scan engine. (optional)
...
# create an instance of the API class
api_instance = py_insightvm_sdk.ScanEngineApi()
engine_pool = py_insightvm_sdk.EnginePool() # EnginePool | The details for the scan engine to update. (optional)
...
api_instance = py_insightvm_sdk.ScanEngineApi()
id = 56 # int | The identifier of the engine pool.
engines = [py_insightvm_sdk.list[int]()] # list[int] | The identifiers of the scan engines to place into the engine pool. (optional)
...
api_instance = py_insightvm_sdk.ScanEngineApi()
id = 56 # int | The identifier of the scan engine.
scan_engine = py_insightvm_sdk.ScanEngine() # ScanEngine | The specification of the scan engine to update. (optional)
