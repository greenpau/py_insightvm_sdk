# py_insightvm_sdk.PolicyOverrideApi
...
api_instance = py_insightvm_sdk.PolicyOverrideApi()
policy_override = py_insightvm_sdk.PolicyOverride() # PolicyOverride | The specification of a policy override. Allows users to override the compliance result of a policy rule. (optional)
