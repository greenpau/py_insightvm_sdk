...
api_instance = py_insightvm_sdk.SiteApi()
id = 56 # int | The identifier of the site.
scan_targets = [py_insightvm_sdk.list[str]()] # list[str] | List of addresses to be the site's new included scan targets. Each address is a string that can represent either a hostname, ipv4 address, ipv4 address range, ipv6 address, or CIDR notation. (optional)
...
api_instance = py_insightvm_sdk.SiteApi()
id = 56 # int | The identifier of the site.
site = py_insightvm_sdk.SiteUpdateResource() # SiteUpdateResource | Resource for updating a site configuration. (optional)
...
id = 56 # int | The identifier of the site.
credential_id = 56 # int | The identifier of the site credential.
site_credential = py_insightvm_sdk.SiteCredential() # SiteCredential | The specification of the site credential to update. (optional)
...
api_instance = py_insightvm_sdk.SiteApi()
id = 56 # int | The identifier of the site.
site_organization = py_insightvm_sdk.SiteOrganization() # SiteOrganization | Resource for updating the specified site's organization information. (optional)
...
id = 56 # int | The identifier of the site.
schedule_id = 56 # int | The identifier of the scan schedule.
scan_schedule = py_insightvm_sdk.ScanSchedule() # ScanSchedule | Resource for updating the specified scan schedule. (optional)
...
id = 56 # int | The identifier of the site.
alert_id = 56 # int | The identifier of the alert.
alert = py_insightvm_sdk.SmtpAlert() # SmtpAlert | Resource for updating the specified SMTP alert. (optional)
...
id = 56 # int | The identifier of the site.
alert_id = 56 # int | The identifier of the alert.
alert = py_insightvm_sdk.SnmpAlert() # SnmpAlert | Resource for updating the specified SNMP alert. (optional)
...
id = 56 # int | The identifier of the site.
alert_id = 56 # int | The identifier of the alert.
alert = py_insightvm_sdk.SyslogAlert() # SyslogAlert | Resource for updating the specified Syslog alert. (optional)
