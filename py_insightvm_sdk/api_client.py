...
from py_insightvm_sdk.configuration import Configuration
import py_insightvm_sdk.models
from py_insightvm_sdk import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'py_insightvm_sdk/1.0.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(py_insightvm_sdk.models, klass)
